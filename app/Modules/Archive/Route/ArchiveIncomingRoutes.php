...
class ArchiveIncomingRoutes extends BaseRoutes
{
	public function __construct()
	{
		$this->controller_ns = 'App\Modules\Archive\Controllers';
		$this->route_prefix = BaseRoutes::GLOBAL_PREFIX . '/archive-incomings';
	}
	...
	public function bind(Application $app)
	{
		$app->router->group([
			...
			$app->router->get('/', [
				...
				'uses' => 'ArchiveIncomingController@data'
			]);
			
			$app->router->get('/{id}', [
				'as' => $this->route_prefix . '.show',
				'uses' => 'ArchiveIncomingController@show'
			]);
		});
	}
}
