                                    ...
                                    <td>
                                        <table class="full" align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td valign="top">
                                                    <!-- left column -->
                                                    <table width="200" align="center" class="res-full" border="0" cellpadding="0" cellspacing="0">
                                                        <!-- image -->
                                                        <tr>
                                                            <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                                                <tr>
                                                                                    <td>
                                                                                    <img width="200" style="max-width: 200px; width: 100%; display: block; line-height: 0px; font-size: 0px; border: 0px;" src="{{ $message->embed(base_path() . '/public/assets/img/logo.png')}}">
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                    ...
                                                    <table width="1" align="left" class="res-full" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td height="1" style="font-size:0px">&nbsp;</td>
                                                        </tr>
                                                    </table>
                            ...
                            <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="res-center" style="text-align: center; color: white; font-family: 'Nunito', Arial, Sans-serif; font-size: 17px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word">
                                        Anda sudah berhasil melakukan perubahan password menjadi
                                    </td>
                                </tr>
                                <!-- paragraph end -->
                                <tr>
                                                                        ...
                                                                        <td>
                                                                            <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                                                ...
                                                                                <tr >
                                                                                    ...
                                                                                    <a href="" style="color: #707070; font-family: 'Nunito', Arial, Sans-serif; font-size: 17px;" >
                                                                                        {{ $details['new_confirm_password'] }}
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
                                                                                <!-- link end -->
